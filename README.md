...
**Aevum** *(Latin: eternity)* — a simple, self-contained desktop app to download videos and audio from **any site**: YouTube, Vimeo, Twitter/X, Dailymotion, Twitch, and ~1,800 more (anything [yt-dlp](https://github.com/yt-dlp/yt-dlp) supports). No installation, no dependencies: everything is bundled into a single `.exe`.
