...
function h264Note(){
  ...
  // Nothing here declares H.264 at all. The site may still be serving it
  // without saying so — the format chain goes looking for exactly that —
  // so there is nothing we can honestly warn about.
  if(!cap)return'';
  let want=0;
